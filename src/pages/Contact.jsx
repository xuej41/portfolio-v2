      ...
      <div className="contact-container">
        ...
        <div className="contact-content">
          <div className="contact-info">
            <a href="https://github.com/xuej41" target="_blank" className="contact-item" rel="noopener noreferrer">
            ...
            <a href="mailto:xuej41@mcmaster.ca" className="contact-item">
              <div className="contact-icon">
            ...
            <a href="https://linkedin.com/in/joshuaxue" target="_blank" className="contact-item contact-item-full-width" rel="noopener noreferrer">
              <div className="contact-icon">
                <svg width="50" height="50" viewBox="0 0 24 24" fill="currentColor">
